...
public class CommandLineArguments {
	...
	public static final String privInfoFlag="priv";
	private boolean usePrivInfo = false;
	
	public static final String privWtFlag ="privWt";
	private double privWt = -1;
	
	private boolean isPrivModel = false;
	...
	public static final String estimatePrivWtFlag = "estimatePrivWt";
	private boolean estimatePrivWt = false;
	...
	public boolean parseArgs(String[] args) {
		for (int i = 0; i < args.length; i++) {		
			...
			if (argMatches(args[i], privInfoFlag)) {
				usePrivInfo = true;
				continue;
			}
			if (argMatches(args[i], privWtFlag)) {
				privWt = Double.parseDouble(args[++i]);
				continue;
			}
			...
			if(argMatches(args[i], estimatePrivWtFlag)) {
				estimatePrivWt = true;
			}
	...
	public double getPrivWt() {
		return privWt;
	}
	
	public void setPrivWt(double w) {
		privWt=w;
	}
	
	public boolean getIsPrivModel() {
		return isPrivModel;
	}
	
	public void setIsPrivModel(boolean b) {
		isPrivModel = b;
	}
	...
	public boolean isUsePrivInfo() {
		return usePrivInfo;
	}
	
	public boolean isEstimatePrivWt() {
		return estimatePrivWt;
	}
}
